...
const API_URL = 'https://api.printful.com';
  const url = `${API_URL}/store/products?category_id=4`;
...
export default async function Page() {
  const ProductData = await getAccessories();

  return(
    <>
    <div>
      <h1 className='flex justify-center text-3xl pt-3 mb-6 font-bold '>Accessories</h1>

...
async function getBottoms() {
  ...
  const url = `${API_URL}/store/products?category_id=106`;
...
export default async function Page() {
  const ProductData = await getBottoms();

  return (
    <>
      <div>
        <h1 className='flex justify-center text-3xl pt-3 mb-6 font-bold '>Bottoms</h1>

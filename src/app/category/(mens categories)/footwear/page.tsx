...
const API_URL = 'https://api.printful.com';
  const url = `${API_URL}/store/products?category_id=205`;
...
export default async function Page() {
  const ProductData = await getFootwear();

  return(
    <>
    <div>
      <h1 className='flex justify-center text-3xl pt-3 mb-6 font-bold '>Footwear</h1>
